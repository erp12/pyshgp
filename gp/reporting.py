...
def print_timings():
    print "Timings:"
    print "Evaluation Times (each gen):", map(lambda x: round(x, 3), timings['evaluation'])
    print "Selection/Variations Times (each gen):", map(lambda x: round(x, 3), timings['genetics'])

...
from pyshgp.gp.variation import VariationOperator, SIZE_NEUTRAL_UMAD
...
class SearchConfiguration:
    ...
    def __init__(self,
                 ...
                 selection: Union[Selector, DiscreteProbDistrib] = "lexicase",
                 variation: Union[VariationOperator, DiscreteProbDistrib] = "umad",
        ...
        if selection == "lexicase":
            self._selection = DiscreteProbDistrib().add(Lexicase(), 1.0)
        ...
        if variation == "umad":
            self._variation = DiscreteProbDistrib().add(SIZE_NEUTRAL_UMAD, 1.0)
...
class SimulatedAnnealing(SearchAlgorithm):
    ...
    # @TODO: More fully describe Simulated Annealing.

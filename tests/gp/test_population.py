...
class TestPopulationMethods(unittest.TestCase):
    ...
    def test_Population_average_error(self):
        ef = lambda program: [np.random.random(), np.random.random()]
        self.pop.evaluate(ef)

...
class LiteralMutation(VariationOperator):
...
# Common instances of variation operators

# UMAD citation: https://dl.acm.org/citation.cfm?id=3205455.3205603
SIZE_NEUTRAL_UMAD = VariationPipeline([AdditionMutation(0.09), DeletionMutation(0.0826)])
SHRINKING_UMAD = VariationPipeline([AdditionMutation(0.09), DeletionMutation(0.1)])
GROWING_UMAD = VariationPipeline([AdditionMutation(0.09), DeletionMutation(0.0652)])

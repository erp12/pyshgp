...
class Individual:
	...
	def __init__(self, genome):
		...
		self.program = tran.translate_plush_genome_to_push_program(genome)
	...
	def set_genome(self, genome):
		...
		"""
		self.genome = genome
		self.program = tran.translate_plush_genome_to_push_program(self.genome)
